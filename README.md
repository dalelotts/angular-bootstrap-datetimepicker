...
In addition, this example has an id of <code>date-dropdown</code> which, because ids should be unique for elements, ensures that your dropdown will function when other dropdowns are present on your page.
