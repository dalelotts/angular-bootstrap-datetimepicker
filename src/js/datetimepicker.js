      ...
      link: function (scope, element, attrs) {
        ...
        var dataFactory = {
          ...
          hour: function (unixDate) {
            ...
            var activeFormat = scope.ngModel ? moment(scope.ngModel).format('YYYY-MM-DD h A') : '';
            ...
            for (var i = 0; i < 24; i++) {
              ...
              var dateValue = {
                ...
                'display': hourMoment.format('h:00 A'),
                'active': hourMoment.format('YYYY-MM-DD h A') === activeFormat
              };
          ...
          minute: function (unixDate) {
            ...
            var activeFormat = scope.ngModel ? moment(scope.ngModel).format('YYYY-MM-DD h:mm A') : '';
            ...
            var result = {
              ...
              'nextView': 'setTime',
              'currentDate': selectedDate.valueOf(),
              'title': selectedDate.format('YYYY-MMM-DD h:mm A'),
            ...
            for (var i = 0; i < limit; i++) {
              ...
              var dateValue = {
                'date': hourMoment.valueOf(),
                'display': hourMoment.format('h:mm A'),
                'active': hourMoment.format('YYYY-MM-DD h:mm A') === activeFormat
              };
